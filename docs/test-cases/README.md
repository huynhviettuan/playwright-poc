...
Use the [`generate-test-cases` skill](../../.claude/skills/generate-test-cases.md) — it reads the user story (if
available), delegates exploration to `explore-screens`, and emits the markdown in the format above.
