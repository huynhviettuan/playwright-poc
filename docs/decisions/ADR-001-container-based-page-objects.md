...
Page objects were becoming monolithic with all elements defined in a single class. Changes to header elements required
modifying the entire page object. This violated Single Responsibility Principle and made code harder to maintain.
