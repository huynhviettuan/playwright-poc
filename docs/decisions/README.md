...
## Context
Page objects were becoming monolithic and hard to maintain. Changes to one section of a page required modifying the entire page object class.

## Decision
Adopt container-based architecture where pages are composed of Header, Main, and Footer containers. Each container manages its own section.
